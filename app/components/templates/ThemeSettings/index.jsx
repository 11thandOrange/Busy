...
const ThemeSettings = ({setSettingsState}) => {
    const themeOptions = [
...
}));}} options={themeOptions} label="Status" helpText="The announcement bar is displayed before/above the page content. When scrolling down, the announcement bar will not be visible anymore."></Selector>
